...
test_dir = '../modelResult/myModel_label3/mHSC_L_result'
# test_dir = '../modelResult/myModel_3/mHSC_L_result_1'
save_dir = test_dir  ### the final performance folder
length_TF = 18

cross_file_path = '../data_evaluation/Time_data/DB_pairs_TF_gene/mesc2_cross_validation_fold_divide.txt'
cross_index = []
...
auc = metrics.roc_auc_score(y_testy, y_predicty)
