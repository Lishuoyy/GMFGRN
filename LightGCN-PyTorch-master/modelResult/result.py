...
def firstPlt(model_set, auroc, auprc, data_name, save_name):
    auroc = auroc[::-1]
    auprc = auprc[::-1]
...
eight_data_auroc = [[0.6322, 0.5069, 0.5848, 0.5534, 0.6162, 0.5759, 0.5194, 0.5098],
                    [0.7025, 0.7071, 0.6746, 0.6363, 0.7538, 0.7007, 0.6997, 0.6932],
                    [0.7233, 0.6817, 0.6538, 0.6513, 0.7866, 0.6955, 0.7003, 0.7003],
                    [0.7926, 0.7357, 0.6906, 0.7143, 0.8856, 0.7992, 0.7967, 0.8068],
                    [0.8054, 0.7961, 0.7102, 0.7386, 0.8882, 0.8103, 0.8131, 0.8156]]
eight_data_auprc = [[0.6647, 0.5815, 0.6212, 0.5400, 0.6030, 0.5729, 0.5211, 0.5051],
                    [0.6846, 0.7033, 0.6690, 0.5938, 0.7558, 0.6575, 0.6516, 0.6444],
                    [0.7084, 0.6871, 0.6437, 0.6008, 0.7268, 0.6463, 0.6524, 0.6543],
                    [0.7805, 0.7344, 0.6759, 0.6547, 0.8249, 0.7339, 0.7302, 0.7458],
                    [0.8013, 0.7702, 0.6998, 0.6806, 0.8231, 0.7682, 0.7582, 0.7825]]
...
# eight data
model_set = ['MFGRN', 'DeepDRIM', 'CNNC', 'MI', 'PCC']
...
firstPlt(model_set, eight_data_auroc, eight_data_auprc, data_name, save_name='eight_data_heatmap.svg')

# five data 500
# model_set = ['MFGRN', 'DeepDRIM', 'CNNC', 'SINCERITIES', 'GENIE3', 'SCODE', 'PIDC']
# # data_set = ['bonemarrow', 'dendritic', 'mesc_1', 'hESC', 'mESC_2', 'mHSC_E', 'mHSC_GM', 'mHSC_L']
# data_name = ['hESC', 'mESC(2)', 'mHSC(E)', 'mHSC(GM)', 'mHSC(L)']
# firstPlt(model_set, five_data_500_auroc, five_data_500_auprc, data_name, save_name='five_data_500_heatmap.svg')

# time data
# model_set = ['MFGRN', 'dynDeepDRIM', 'TDL-LSTM', 'TDL-3DCNN', 'MI', 'PCC', 'dynGENIE3']
# data_name = ['mESC1', 'mESC2', 'hESC1', 'hESC2']
# firstPlt(model_set, time_data_auroc, time_data_auprc, data_name, save_name='time_data_heatmap.svg')
